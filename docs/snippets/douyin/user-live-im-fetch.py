...
async def main():
    ...
    # logger.info(
    #     f"直播间IM页码：{live_im.cursor} 直播间IM扩展：{live_im.internal_ext}"
    # )
...
async def main():
    ...
    logger.info(f"直播间IM页码：{live_im.cursor} 直播间IM扩展：{live_im.internal_ext}")
